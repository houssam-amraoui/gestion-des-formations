...
public sealed class LessonProgressService(ApplicationDbContext db) : ILessonProgressService
{
        ...
        CancellationToken token = default)
    {
        ...
        return ServiceResult<TrainingProgressSummary>.Success(await RecalculateCoreAsync(enrollment, token));
    }
