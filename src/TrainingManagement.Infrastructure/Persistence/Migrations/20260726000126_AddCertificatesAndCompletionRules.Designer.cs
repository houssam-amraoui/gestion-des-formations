...
namespace TrainingManagement.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260726000126_AddCertificatesAndCompletionRules")]
    partial class AddCertificatesAndCompletionRules
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TrainingManagement.Domain.Entities.Training", b =>
                {
                    ...
                    b.ToTable("Trainings", t =>
                        {
                            t.HasCheckConstraint("CK_Training_CertificateValidityMonths", "CertificateValidityMonths IS NULL OR CertificateValidityMonths > 0");

                            t.HasCheckConstraint("CK_Training_MinimumAverageScore", "MinimumAverageScore IS NULL OR (MinimumAverageScore >= 0 AND MinimumAverageScore <= 100)");
                        });
                });
